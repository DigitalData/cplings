...
long long integer_char_sizes() {
    const char a = 10;
    const char b = a - 34; // Fix: set expected value to pass the test
    std::cout << "Integer type = char \n";
    std::cout << "val=" << static_cast<char>(b) << "\n";
...
long long unsigned_integer_char_sizes() {
    ...
    const unsigned char b = 242 - a;  // Fix: set expected value to pass the test
    std::cout << "Integer type = char \n";
    std::cout << "a=" << static_cast<int>(a) << "   b=" << static_cast<int>(b) << "\n";
    std::cout << "size of a=" << sizeof(a) << "  size of b=" << sizeof(b) << "\n\n";
    return  static_cast<long long>(b);
...
long long integer_long_sizes() {
    ...
    const long b = 81000 - a;  // Fix: set expected value to pass the test
...
long long integer_int_sizes() {
    const int a = 1'000LL;
    const int b = 10 * a * a;  // Fix: set expected value to pass the test
...
unsigned long long unsigned_integer_long_long_sizes() {
  ...
  const unsigned long long b = 0 - a; // Fix: set expected value to pass the test
  std::cout << "a=" << static_cast<long long>(a) << "   b=" << static_cast<long long>(b) << "\n";
  std::cout << "size of a=" << sizeof(a) << "  size of b=" << sizeof(b) << "\n\n";
  std::cout << b << "\n";
  return b;
